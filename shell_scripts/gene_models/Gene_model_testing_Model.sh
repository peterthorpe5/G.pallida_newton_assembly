...
nem_dir=/storage/home/users/User_name/newton/gene_models/brakerrnaseq/

known_fa="${nem_dir}/Gpal_aa_fromNCBI_JJ.fasta"
known_fa_nucl="${nem_dir}/augustus.hints.codingseq"
prefix="GPALNEWT"
test_fa="augustus.hints.aa"
test_fa_nt="augustus.hints.codingseq"

min_len_gene="5"
threads=12
python_directory=$HOME/public_scripts/gene_model_testing/
Working_directory=/storage/home/users/User_name/newton/gene_models/brakerrnaseq/
