...
cd /shelf/apps/User_name/newton/newton_wtdgb/L4000/sspace_long_read_A80_k/sspace_long_read_A80_k/sspace_long_read_A80_k
...
#minialign -t16 -xont scaffolds_gapfilled_FINAL.fasta /storage/home/users/User_name/shelf_apps/newton/newton_using_EC_reads_EC85.correctedReads.fasta.gz > temp.sam
wait 
#samtools view -@ 10 -S -b -o unsorted.bam temp.sam
wait 
#samtools sort -@ 8 -o sorted unsorted.bam 
...
##
#
purge_haplotigs purge  -g scaffolds_gapfilled_FINAL.fasta  -c coverage_stats.csv  -b sorted.bam  -t 8 -a 80
...
#
#purge_haplotigs purge  -g scaffolds_gapfilled_FINAL.fasta  -c coverage_stats.csv  -b sorted.bam  -t 16 -a 70
#
