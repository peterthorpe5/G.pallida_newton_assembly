...
cd /storage/home/users/pjt6/newton/comparative_genomics/all_nems/gros/
rm *fasta_*
...
grep "Probability: o3=" -H *_stats.txt > ~/newton/comparative_genomics/all_nems/gros_no_gaps_NO_MINC_orthofinder_DN_DS.txt
