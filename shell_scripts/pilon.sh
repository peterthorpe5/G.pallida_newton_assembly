...
cd /shelf/apps/pjt6/newton/final_contigs
...
#minimap2 -t $THREADS -ax map-pb curated_A80.fasta /shelf/apps/pjt6/newton/reads/all_pacbio.fastq.gz > aln.sam
...
#bwa index curated_A80.fasta
#bwa mem -t $THREADS curated_A80.fasta /shelf/apps/pjt6/newton/DNAseq/R1_prinseq_good_pm0d.fastq /shelf/apps/pjt6/newton/DNAseq/R2_prinseq_good_vVZt.fastq > new.illumina.mapped.sam
...
pilon --genome curated_A80.fasta --bam new.illumina.mapped.bam --pacbio sorted_mini2.bam --changes --vcf --diploid --threads $THREADS --output Newton_Illumina_pilon_iter1
...
minimap2 -t $THREADS -ax map-pb Newton_Illumina_pilon_iter1.fasta /shelf/apps/pjt6/newton/reads/all_pacbio.fastq.gz > aln.sam
samtools view -@ $THREADS -S -b -o alnunsorted.bam aln.sam
wait
samtools sort -@ $THREADS -o  sorted_mini2.bam alnunsorted.bam
samtools index sorted_mini2.bam
...
bwa mem -t $THREADS Newton_Illumina_pilon_iter1.fasta /shelf/apps/pjt6/newton/DNAseq/R1_prinseq_good_pm0d.fastq /shelf/apps/pjt6/newton/DNAseq/R2_prinseq_good_vVZt.fastq > new.illumina.mapped.sam
...
minimap2 -t $THREADS -ax map-pb Newton_Illumina_pilon_iter2.fasta /shelf/apps/pjt6/newton/reads/all_pacbio.fastq.gz > aln.sam
samtools view -@ $THREADS -S -b -o alnunsorted.bam aln.sam
wait
samtools sort -@ $THREADS -o  sorted_mini2.bam alnunsorted.bam
samtools index sorted_mini2.bam
bwa index Newton_Illumina_pilon_iter2.fasta
bwa mem -t $THREADS Newton_Illumina_pilon_iter2.fasta /shelf/apps/pjt6/newton/DNAseq/R1_prinseq_good_pm0d.fastq /shelf/apps/pjt6/newton/DNAseq/R2_prinseq_good_vVZt.fastq > new.illumina.mapped.sam
...
minimap2 -t $THREADS -ax map-pb Newton_Illumina_pilon_iter3.fasta /shelf/apps/pjt6/newton/reads/all_pacbio.fastq.gz > aln.sam
samtools view -@ $THREADS -S -b -o alnunsorted.bam aln.sam
wait
samtools sort -@ $THREADS -o  sorted_mini2.bam alnunsorted.bam
samtools index sorted_mini2.bam
...
bwa mem -t $THREADS Newton_Illumina_pilon_iter3.fasta /shelf/apps/pjt6/newton/DNAseq/R1_prinseq_good_pm0d.fastq /shelf/apps/pjt6/newton/DNAseq/R2_prinseq_good_vVZt.fastq > new.illumina.mapped.sam
...
minimap2 -t $THREADS -ax map-pb Newton_Illumina_pilon_iter4.fasta /shelf/apps/pjt6/newton/reads/all_pacbio.fastq.gz > aln.sam
samtools view -@ $THREADS -S -b -o alnunsorted.bam aln.sam
wait
samtools sort -@ $THREADS -o  sorted_mini2.bam alnunsorted.bam
samtools index sorted_mini2.bam
...
bwa mem -t $THREADS Newton_Illumina_pilon_iter4.fasta /shelf/apps/pjt6/newton/DNAseq/R1_prinseq_good_pm0d.fastq /shelf/apps/pjt6/newton/DNAseq/R2_prinseq_good_vVZt.fastq > new.illumina.mapped.sam
...
minimap2 -t $THREADS -ax map-pb Newton_Illumina_pilon_iter5.fasta /shelf/apps/pjt6/newton/reads/all_pacbio.fastq.gz > aln.sam
samtools view -@ $THREADS -S -b -o alnunsorted.bam aln.sam
wait
samtools sort -@ $THREADS -o  sorted_mini2.bam alnunsorted.bam
samtools index sorted_mini2.bam
...
bwa mem -t $THREADS Newton_Illumina_pilon_iter5.fasta /shelf/apps/pjt6/newton/DNAseq/R1_prinseq_good_pm0d.fastq /shelf/apps/pjt6/newton/DNAseq/R2_prinseq_good_vVZt.fastq > new.illumina.mapped.sam
...
#
#minimap2 -t $THREADS -ax map-pb Newton_Illumina_pilon_iter5.fasta /shelf/apps/pjt6/newton/reads/all_pacbio.fastq.gz > aln2.sam
