...
def run_repeat_masker(query, RepeatMasker = '/shelf/apps/User_name/conda/envs/repeatmasking/bin/RepeatMasker', engine=False, parallel=8,
...
def run_repeatmodeler(database, RepeatModeler='perl /shelf/apps/User_name/conda/envs/repeatmasking/bin/RepeatModeler', pa='8', engine='ncbi',
                     species='eukaryota'):
    frame = inspect.currentframe()
    args, _, _, values = inspect.getargvalues(frame)
    del values['frame']
