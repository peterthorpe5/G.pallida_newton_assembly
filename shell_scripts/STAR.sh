...
cd /shelf/apps/pjt6/newton/RNAseq/
...
# index the genome
/shelf/apps/pjt6/apps/STAR-master/bin/Linux_x86_64_static/STAR --runMode genomeGenerate --runThreadN 16 --limitGenomeGenerateRAM 259760745173 \
