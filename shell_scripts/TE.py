...
def run_repeat_masker(query, RepeatMasker = '/storage/home/users/User_name/shelf_apps/apps/RepeatMasker/RepeatMasker', engine=False, parallel=8,
...
def make_repeatmodeler_database(name, input_filename, BuildDatabase='/shelf/apps/User_name/conda/envs/repeatmasking/bin/BuildDatabase',
...
def run_repeatmodeler(database, RepeatModeler='perl /shelf/apps/User_name/apps/RepeatModeler-open-1.0.11/RepeatModeler', pa='8', engine='ncbi',
                     species='eukaryota'):
    frame = inspect.currentframe()
    args, _, _, values = inspect.getargvalues(frame)
    del values['frame']
...
def run_OneCodeToFindThemAll(pooled_RM_outputs_dir, #The directory containing repeatmasker .out files or a path to a specific .out file
                            ...
                            unknown=False,
                            strict=True,
                            build_dictionary = '/storage/home/users/User_name/shelf_apps/apps/one_code/build_dictionary.pl',
                            octfta = '/storage/home/users/User_name/shelf_apps/apps/one_code/OneCodeToFindThemAll.pl',
                            ):
